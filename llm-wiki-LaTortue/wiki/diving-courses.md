...
**Summary**: Current published course structure, course families, prices, and certification positioning.
...
The diving courses page positions La Tortue as offering SSI and FFESSM programs from beginner to pro in small groups with personalized attention (source: diving.html; source: fr/diving.html). Navigation exposes partner links for SSI and FFESSM courses in both desktop and mobile menus (source: menu.html; source: fr/menu.html).
...
SSI Pro training currently includes Divemaster and Open Water Instructor surfaces (source: diving.html; source: fr/diving.html). Divemaster is listed as 4 to 6 weeks from PHP 67,500 with prerequisite specialties and minimum logged dives; Open Water Instructor is listed as 2 weeks at PHP 140,000 with Divemaster, Enriched Air Nitrox, and Open Water Diver duration prerequisites (source: diving.html).

The Instructor Training Course has a dedicated callout image and schedule asset on the diving page (source: diving.html; source: fr/diving.html).
...
The site-content search summaries describe the diving page as "SSI and FFESSM courses from beginner level to professional training in Dauin" in English and equivalent French wording in `site-content-fr.js` (source: assets/js/site-content-en.js; source: assets/js/site-content-fr.js).
