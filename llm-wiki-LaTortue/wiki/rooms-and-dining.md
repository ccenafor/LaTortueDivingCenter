...
**Summary**: Current accommodation, room pricing, restaurant positioning, day-pass information, and menu surfaces.
...
The French room descriptions state that Seaview and Garden cottages are fan rooms for two with queen beds and terrace access, while Deluxe is air-conditioned with a queen bed and sofa bed for up to three, private bathroom, hot shower, and amenities (source: fr/cottages.html). The English page has corresponding room cards, images, details, and common amenities (source: cottages.html).

## Restaurant And Day Pass

The dining page positions the restaurant as beach dining with breakfast classics, Filipino favorites, pasta, burgers, fruit shakes, and cocktails (source: dining.html; source: fr/dining.html). The PHP 200 Day Pass is fully consumable on food and drinks and provides beach access, seating, and full menu access from 8:30am to 7:30pm (source: dining.html; source: fr/dining.html).

The dining page includes a food/drink showcase gallery and a "2026 Menu" section with menu images and lightbox behavior (source: dining.html; source: fr/dining.html; source: assets/site.js).
